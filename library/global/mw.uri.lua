...
---URI manipulation and encoding functions.
mw.uri = {}
...
---@return MwUri #The URI object for the canonical URL.
...
---@param page string The page name.
---@param query? QueryParamsEncoded | string The optional query string/table.
---@return MwUri #The URI object for the full URL.
...
---@param page string The page name.
---@param query? QueryParamsEncoded | string The optional query string/table.
---@return MwUri #The URI object for the local URL.
function mw.uri.localUrl(page, query) end

---Constructs a new URI object for the passed string or table.
---@param input string | table | MwUri The string or table to construct the URI object from.
---@return MwUri #The new URI object.
function mw.uri.new(input) end

---Validates the passed table (or URI object).
---@param table table | MwUri The table or URI object to validate.
...
---@return MwUri #The current URI object.
function MwUri:parse(string) end

---Makes a copy of the URI object.
---@return MwUri #A new URI object that is a copy of the current object.
function MwUri:clone() end
...
---@return MwUri #The current URI object.
function MwUri:extend(parameters) end
